...
interface CartContextType {
  ...
  addProduct: (id: string) => Promise<any>;
  deleteProduct: (id: string) => Promise<any>;
  updateProductQuantity: (id: string, quantity: number) => Promise<any>;
...
export default function CartContextProvider(props: CartContextProviderProps) {
  ...
  if (!auth || !auth.userToken) {
    throw new Error('Auth context is not properly initialized or userToken is missing.');
  }
