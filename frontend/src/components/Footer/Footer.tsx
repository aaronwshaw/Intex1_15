    ...
    <footer className="bg-white border border-t-1 mt-6 dark:bg-gray-900">
      <div className="p-6 mx-auto">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3">
              ...
              <div>
                ...
                {[
                  {
                    name: 'Daniels',
                    url: 'https://mohamedemary.github.io/route-frontend/assignments/10-daniels/index.html',
                  },
                  {
                    name: 'Devfolio',
                    url: 'https://mohamedemary.github.io/route-frontend/assignments/07-devFolio/index.html',
                  },
                  {
                    name: 'Game Over',
                    url: 'https://game-over-ivory.vercel.app/',
                  },
                  {
                    name: 'Todo App',
                    url: 'https://todo-app-wine-tau.vercel.app/',
                  },
                ].map((site) => (
                  <a
                    key={site.name}
                ...
                {userToken ? (
                  <>
                    ...
                    <Link to="/brands" className="footer-link">
                      <i className="fa-fw fas fa-tags"></i> Brands
                    </Link>
        ...
        <div className="text-center text-gray-500 dark:text-gray-400">
          ...
          <span className="italic text-md">Confucius</span>
        </div>
