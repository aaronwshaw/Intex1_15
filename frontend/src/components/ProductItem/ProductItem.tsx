...
export default function ProductItem({
  ...
  if (!cartCtx) {
    throw new Error('cartContext is null. Ensure the provider is set up correctly.');
  }
  ...
  if (!productsCtx) {
    throw new Error('productsContext is null. Ensure the provider is set up correctly.');
  }

  const { renderStars } = productsCtx;
